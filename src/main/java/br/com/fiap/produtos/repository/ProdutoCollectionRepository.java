...
public class ProdutoCollectionRepository {
    ...
    static {
        ...
        celular.setNome("Iphone 18 Pro Max")
                .setDescricao("Aparelho celular da Aplle").setCategoria(CategoriaCollectionRepository.findById(2l))
                .setDataDeCadastro(LocalDateTime.now()).setPreco(BigDecimal.valueOf(18000));
